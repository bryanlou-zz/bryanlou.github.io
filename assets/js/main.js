    ...
    1: [function(e, t, n) {
        window.px = function() {
            ...
            $.fn.panel = function(e) {
                ...
                var n, i = $(this), o = $("body"), a = $(window), r = i.attr("id");
                return n = $.extend({
                    delay: 0,
                    hideOnClick: !1,
                    hideOnEscape: !1,
                ...
                "jQuery" != typeof n.target && (n.target = $(n.target)),
                i._hide = function(e) {
                    n.target.hasClass(n.visibleClass) && (e && (e.preventDefault(),
                    e.stopPropagation()),
                    n.target.removeClass(n.visibleClass),
                    window.setTimeout(function() {
                        n.resetScroll && i.scrollTop(0),
                        n.resetForms && i.find("form").each(function() {
                            this.reset()
                        })
                    }, n.delay))
                }
                ...
                n.hideOnClick && (i.find("a").css("-webkit-tap-highlight-color", "rgba(0,0,0,0)"),
                i.on("click", "a", function(e) {
                    var t = $(this)
                      , o = t.attr("href")
                      , a = t.attr("target");
                    o && "#" != o && "" != o && o != "#" + r && (e.preventDefault(),
                    e.stopPropagation(),
                    i._hide(),
                    window.setTimeout(function() {
                ...
                i.on("touchmove", function(e) {
                    if (null !== i.touchPosX && null !== i.touchPosY) {
                        ...
                        if (n.hideOnSwipe) {
                            ...
                            if (s)
                                return i.touchPosX = null,
                                i.touchPosY = null,
                                i._hide(),
                                !1
                        }
                        (i.scrollTop() < 0 && o < 0 || r > a - 2 && r < a + 2 && o > 0) && (e.preventDefault(),
                        e.stopPropagation())
                    }
                }),
                ...
                o.on("click", 'a[href="#' + r + '"]', function(e) {
                    e.preventDefault(),
                    e.stopPropagation(),
                    n.target.toggleClass(n.visibleClass)
                }),
            ...
            function(e) {
                ...
                e.fn.scrolly = function(n, i) {
                    n || (n = 1e3),
                    i || (i = 0),
                    e(this).off(t).on(t, function(t) {
                        var o, a, r, s = e(this), l = s.attr("href");
                        "#" == l.charAt(0) && l.length > 1 && (o = e(l)).length > 0 && (a = o.offset().top,
                        s.hasClass("scrolly-centered") ? r = a - (e(window).height() - o.outerHeight()) / 2 : (r = Math.max(a, 0),
                        i && (r -= "function" == typeof i ? i() : i)),
                        t.preventDefault(),
            ...
            var t = {
                ...
                stripeInitForm: function(e) {
                    ...
                    $("#cc_number").on("keyup change", function() {
                        ...
                        n.hasOwnProperty(o) && n[o].addClass("active"))
                    }).trigger("change"),
                    e.on("beforeSubmit", function(t) {
                        ...
                        if (2 == n)
                            return Stripe.card.createToken({
                                ...
                                web.fieldValue(e, "cc_error", ""),
                                web.fieldValue(e, "cc_token", ""),
                                n.error ? web.fieldValue(e, "cc_error", n.error.message) : web.fieldValue(e, "cc_token", n.id),
                                e.trigger("submit", !0)
                            }),
                            !1
                    })
                ...
                iframeLocation: function(e, t) {
                    var n, i, o;
                    return n = $("#" + e),
                    0 != n.length && (i = n.get(0),
                    o = i.contentWindow.location.href ? i.contentWindow.location.href.toString().match(/\/\/[^\/]+(\/[^\.]+)\//)[1] : "",
                    i.contentWindow.location.replace(o + "/" + t),
                    !0)
                },
                cookie: function(e, t, n, i) {
                    if ("" === t)
                        return i || (i = "/"),
                        document.cookie = e + "=; expires=Thu, 1 Jan 1970 12:00:00 UTC; path=" + i,
                        null;
                    if (t) {
                        var o, a;
                        return n || (n = 0),
                        ...
                        a = o.toGMTString(),
                        i || (i = "/"),
                        document.cookie = e + "=" + t + "; expires=" + a + "; path=" + i,
                        t
                    }
                ...
                initClient: function() {
                    if (t.client.loggedIn = null !== t.cookie("awz"),
                    t.client.loggedIn) {
                        var e, n;
                        (e = t.b64d(t.cookie("awx"))) && (n = e.split("|"),
                        "*" == n[0] && (n[0] = t.time().toString(),
                        e = n.join("|"),
                        t.cookie("awx", t.b64e(e), parseInt(n[0]) + parseInt(n[1]) + 86400)),
                        t.client.subscription.timestamp = parseInt(n[0]) + parseInt(n[1]),
                        t.client.subscription.string = n[2],
                        t.client.subscribed = t.client.subscription.timestamp > t.time())
                    }
                },
                initModal: function(e) {
                    var n, i, o = $("#" + e);
                    o.wrapInner("<section />"),
                    n = o.children("section"),
                    n.on("click", function(e) {
                        e.stopPropagation()
                    }),
                    i = $('<div class="closer"></div>'),
                    i.appendTo(n).on("click", function() {
                        return o._hide(),
                        !1
                    }),
                    o._show = function() {
                ...
                initPage: function() {
                    switch (t.pageId = t.obj.$body.attr("class").split(" ")[0].split("-")[1],
                    skel.vars.mobile && t.obj.$body.addClass("is-mobile"),
                    "ie" == skel.vars.browser && t.obj.$body.addClass("is-ie"),
                    $(".scrolly").scrolly(),
                    ...
                    window.location.hash && t.obj.$window.on("load.hash", function() {
                        ...
                        t.obj.$window.off("load.hash")
                    }),
                    $(".tooltip").each(function() {
                        var e, n = $(this), i = n.attr("title");
                        if (i)
                            n.prepend('<div class="content">' + i + "</div>"),
                            n.removeAttr("title");
                        else if (0 == n.children(".content").length)
                            return;
                        e = n.children(".content"),
                        n._reposition = function() {
                    ...
                    function() {
                        var e, t = $(window), n = [], i = 0, o = skel.vars.touch ? -750 : -250, a = function() {
                            var e, i, a = n.length, r = t.scrollTop() + t.height() - o;
                            for (e = 0; e < a; e++)
                                i = n[e],
                                !i.state && r > i.o.offset().top && (i.state = !0,
                                i.fn())
                        };
                        t.on("load", function() {
                    ...
                    "wp" == skel.vars.os ? $(".image.lazy").each(function() {
                        var e = $(this);
                        $p = e.children(".placeholder"),
                        src = $p.data("src"),
                        $p.attr("src", src),
                        e.addClass("is-cached")
                    ...
                    $('<a href="#menu" id="menuToggle"></a>').appendTo(t.obj.$header),
                                ...
                                (!skel.vars.mobile || !skel.breakpoint("xsmall").active) && t.obj.$header.hasClass("alt") && t.obj.$banner.length > 0 && t.obj.$window.on("load", function() {
                                    !function() {
                                        ...
                                        $.fn[e] = function(u) {
                                            ...
                                            p = $(this),
                                            h.init && (g = h.init),
                                            p[s](l, -1)[r](function(e) {
                                                window.clearTimeout(b),
                                                b = window.setTimeout(function() {
                                                    var t, i, r = parseInt(p[s](l));
                                                    return (0 == r || r == -1) && (t = h[o] === c || e >= h[o],
                                                    i = h[a] === c || e <= h[a],
                                                    t && i) ? (p[s](l, 1),
                                                    h.on && h.on(p),
                                                    g && (g(p, !0),
                                                    g = n),
                                                    void 0) : (1 == r || r == -1) && (t = h[o] !== c && e < h[o],
                                                    i = h[a] !== c && e > h[a],
                                                    t || i) ? (p[s](l, 0),
                                                    h.off && h.off(p),
                                                    g && (g(p, c),
                                        ...
                                        $.fn[r] = function(e, n, o) {
                                            ...
                                            u = c[s](o + b),
                                            f = g + o + "-" + u,
                                            k.off(f).on(f, function() {
                                                var t, n = c.offset()[i], o = c.outerHeight();
                                                C[v]();
                                                switch (l.scope) {
                                                default:
                                                case p:
                                                ...
                                                "forwards" == l.direction ? t = Math.max(0, t) : "backwards" == l.direction && (t = Math.min(0, t)),
                                                t > 0 ? t = Math.max(0, t - l.easing / 100) : t < 0 && (t = Math.min(0, t + l.easing / 100)),
                                                e(t, c)
                                            }).trigger("scroll"),
                                            c
                                        }
                                    ...
                                    t.obj.$banner.scrollwatch({
                                        ...
                                        on: function() {
                                            t.obj.$header.addClass("alt"),
                                            t.obj.$header.removeClass("reveal")
                                        },
                                        off: function() {
                                            t.obj.$header.removeClass("alt"),
                                            t.obj.$header.addClass("reveal")
                                        }
                                    })
                                });
                                var e, n, i;
                                (e = t.b64d(t.cookie("awi"))) && (n = e.split("|"),
                                2 == n.length && (i = parseInt(n[0])) > 0 && i < 100 && ($(".base-price").each(function() {
                                    var e = $(this)
                    ...
                    case "item":
                        !function() {
                            var e, n, i, o, a = !1, r = function() {
                                ...
                                d.hasClass(i) || (d.removeClass("desktop").removeClass("mobile-portrait").removeClass("mobile-landscape").removeClass("tablet-portrait").removeClass("tablet-landscape"),
                                d.addClass(i)),
                                f[0].contentWindow.location.pathname == a && o !== !0 || f[0].contentWindow.location.replace(a),
                                setTimeout(function() {
                                    s()
                            ...
                            if (t.obj.$window.on("resize", function() {
                                h.triggerHandler("resize.scrollbarify"),
                                t.obj.$body.addClass("is-resizing"),
                                clearTimeout(o),
                            ...
                            skel.vars.mobile)
                                t.obj.$body.addClass("is-frame-loading"),
                                t.obj.$window.on("load", function() {
                                    setTimeout(function() {
                                ...
                                f.on("load", function() {
                                    ...
                                    e._pxOpen = function(t) {
                                        var i = t.split(".")[0]
                                          , o = k.filter('[data-name="' + i + '"]');
                                        o.length > 0 ? o.triggerHandler("click") : (k.removeClass("active"),
                                        n = i,
                                    ...
                                    f.contents().find("a").each(function() {
                                        var e = $(this)
                                          , t = e.attr("href");
                                        1 != e.data("pxFixed") && "undefined" != typeof t && ("#" == t ? e.removeAttr("href").css("cursor", "pointer") : t.match(/html$/) && e.attr("href", "javascript:window._pxOpen('" + t + "');"),
                                        e.data("pxFixed", 1))
                                    })
                                })
                            }
                            ...
                            skel.vars.mobile || h.scrollbarify(),
                            !skel.vars.mobile) {
                                var p = $('<div class="actions"><div class="toggle" title="Toggle sidebar"></div><div class="popout" title="Open in new tab"></div><div class="reload" title="Reload demo"></div></div>').prependTo(h)
                                  ...
                                  , v = p.find(".reload");
                                b.on("click", function() {
                                    r() && (t.obj.$body.addClass("is-changing"),
                                    setTimeout(function() {
                                        t.obj.$body.toggleClass("is-minimized"),
                                        setTimeout(function() {
                                            h.triggerHandler("resize.scrollbarify"),
                                            t.obj.$body.removeClass("is-changing"),
                                            s()
                                        }, 500)
                                    }, 125))
                                }),
                            ...
                            var x, _ = h.find(".downloads"), T = _.find(".versions"), I = T.children("li"), P = h.find(".message");
                            ...
                            case "subscribed":
                                P.html("Subscribed until " + t.client.subscription.string + ' (<a href="/account">My Account</a>)'),
                                I.each(function() {
                                    var e = $(this)
                                      , t = e.find(".button")
                                    ...
                                    h.triggerHandler("resize.scrollbarify"),
                                    t.attr("href", _item.id + "/download/" + o).text("Download")
                                });
                                break;
                            case "expired":
                                P.html('Access plan inactive :( Please <a href="/account/renew">renew</a> to instantly download this template.'),
                                I.each(function() {
                                    var e = $(this)
                                      , t = e.find(".button");
                                    e.data("name");
                ...
                initPolyfills: function() {
                    ...
                    !function() {
                        ...
                        t.btoa || (t.btoa = function(t) {
                            for (var n, o, a = String(t), r = 0, s = i, l = ""; a.charAt(0 | r) || (s = "=",
                            r % 1); l += s.charAt(63 & n >> 8 - r % 1 * 8)) {
                                if (o = a.charCodeAt(r += .75),
                                o > 255)
                        ...
                        t.atob || (t.atob = function(t) {
                            ...
                            for (var o, a, r = 0, s = 0, l = ""; a = n.charAt(s++); ~a && (o = r % 4 ? 64 * o + a : a,
                            r++ % 4) ? l += String.fromCharCode(255 & o >> (-2 * r & 6)) : 0)
                                a = i.indexOf(a);
                            return l
                        }
                        )
                ...
                init: function() {
                    ...
                    t.initClient(),
                    t.initSkel(),
                    t.client.loggedIn && $("head").append("<style>.page-landing #banner,.page-landing #pricing{display:none!important}</style>"),
                    $(function() {
                        t.initObj(),
                        t.obj.$body.addClass("is-loading"),
                        t.obj.$window.on("load", function() {
